    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6">
      ...
      >
        <div className="mb-10">
          ...
          <p className="text-zinc-500 text-sm font-medium">Welcome back. Enter your credentials to continue.</p>
        </div>
        ...
        <div className="mt-10 pt-8 border-t border-white/5 text-center">
          <p className="text-zinc-500 text-sm font-medium">
            Don't have an account? <Link href="/register" className="text-white hover:underline underline-offset-4 transition-colors">Create an account</Link>
          </p>
        </div>
      </motion.div>
